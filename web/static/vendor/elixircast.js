...
Elm.ElixirCast = Elm.ElixirCast || {};
Elm.ElixirCast.make = function (_elm) {
   "use strict";
   _elm.ElixirCast = _elm.ElixirCast || {};
   if (_elm.ElixirCast.values) return _elm.ElixirCast.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var main = $Html.text("I\'m so hyped that I got Phoenix running on Elixir with Semantic UI! But will this update now?");
